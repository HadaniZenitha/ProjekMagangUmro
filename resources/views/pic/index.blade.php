...
<style>
    ...
    .aksi-group .btn-warning {
        background-color: #ffc107;
        border: none;
        color: #000;
    }

    .aksi-group .btn-danger {
...
<div class="mb-3 d-flex flex-md-row flex-column align-items-md-center gap-2 pic-toolbar">
    ...
    <div class="d-flex gap-2 ms-md-auto mt-2 mt-md-0 flex-column flex-md-row">
        <button class="btn btn-success btn-clean btn-mobile-full" data-bs-toggle="modal"
            data-bs-target="#modalImportPic">
            <i class="fas fa-file-excel me-1"></i> Import Excel
        </button>

        <a href="{{ route('pic.create') }}" class="btn btn-warning btn-clean btn-mobile-full">
...
@if(session('warning'))
    <div class="alert alert-warning alert-dismissible fade show">
        ...
        @if(session('import_errors'))
            <button class="btn btn-sm btn-outline-dark mt-2" type="button" data-bs-toggle="collapse"
                data-bs-target="#errorDetailsPic">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="aksi-group">
                                ...
                                <a href="{{ route('pic.edit', $p->id) }}" class="btn btn-warning">
                                    <i class="fa-solid fa-pen"></i>
                                </a>

                                <form action="{{ route('pic.destroy', $p->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button onclick="return confirm('Hapus karyawan ini?')" class="btn btn-danger">
