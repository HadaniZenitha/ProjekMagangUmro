        ...
        <div class="menu-container">
            ...
            <div class="collapse {{ request()->routeIs(['divisi.*','pic.*']) ? 'show' : '' }} sub-menu" id="menuKaryawan">
                <a href="{{ route('divisi.index') }}" class="{{ request()->routeIs('divisi.*') ? 'active-sub' : '' }}">
                    BIDANG <i class="fa-solid fa-building"></i>
                </a>
                <a href="{{ route('pic.index') }}" class="{{ request()->routeIs('pic.*') ? 'active-sub' : '' }}">
                    KARYAWAN <i class="fa-solid fa-user-tie ms-2"></i>
                </a>
            </div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div style="position:relative;">
                        ...
                        <div id="searchResults"
                             style="position:absolute; top:35px; left:0; width:300px; background:white; border-radius:6px; box-shadow:0 5px 15px rgba(0,0,0,0.15); display:none; max-height:300px; overflow:auto; z-index:999;">
                        </div>
                    </div>
                </div>
            </div>
        ...
        searchInput.addEventListener('keyup', function() {
            ...
            fetch(`/search?q=${keyword}`)
                ...
                .then(data => {
                    ...
                    if (html === '') {
                        html = `<div style="padding:12px;text-align:center;color:#888">Tidak ada hasil ditemukan</div>`;
                    }
    ...
    <div class="modal fade" id="infoModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header text-white" style="background: linear-gradient(135deg,#309FB0,#1F7A88);">
                ...
                <div class="modal-body">
                    <div class="text-center mb-4">
                        <img src="{{ asset('images/pln.jpeg') }}" height="70" class="mb-2">
                        <h3 class="fw-bold mb-1">i - Noni</h3>
                        <p class="text-muted mb-0">Sistem Inventarisasi UNIT MAINTENANCE REPAIR AND OVERHAUL</p>
                        <span class="badge bg-secondary mt-2">Versi 1.0.0</span>
                    </div>
                    ...
                    <div class="mb-4">
                        <h6 class="fw-bold text-primary mb-2">
                            <i class="fa-solid fa-circle-info me-2"></i> Tentang Sistem
                        </h6>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row text-center">
                            <div class="col-md-4 mb-3">
                                ...
                                <small class="text-muted">Mengelola data bidang dan karyawan</small>
                            </div>
                            <div class="col-md-4 mb-3">
                                <i class="fa-solid fa-building fa-2x text-success mb-2"></i>
                                <h6 class="fw-bold mb-1">Manajemen Lokasi</h6>
                                <small class="text-muted">Mengelola gedung, lantai, dan ruangan</small>
                            </div>
                            <div class="col-md-4 mb-3">
                                <i class="fa-solid fa-box fa-2x text-warning mb-2"></i>
                                <h6 class="fw-bold mb-1">Inventaris Barang</h6>
                                <small class="text-muted">Pengelolaan data barang dan aset</small>
                            </div>
                        </div>
                    </div>
                ...
                <form method="POST" action="{{ route('profile.update') }}">
                    ...
                    <div class="d-flex gap-2">
                        <button type="button" class="btn btn-secondary w-50" 
                                onclick="cancelEditProfile()">Batal</button>
