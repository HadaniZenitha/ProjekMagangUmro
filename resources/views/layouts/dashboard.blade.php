...
<head>
    ...
    <style>
        ...
        /* ================= SEARCH DROPDOWN (DESKTOP + GLOBAL) ================= */
        ...
        /* MUNCUL SAAT HOVER */
        .search-item:hover .search-icon-right {
            opacity: 1;
        }
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-brand d-flex align-items-center gap-2">
            ...
            <i class="fa-solid fa-arrow-left d-lg-none me-2" onclick="toggleSidebar()"
        ...
        <div class="menu-container">
            ...
            @if(!auth()->user()->hasRole('timinventarisasi') && !auth()->user()->hasRole('user'))
                ...
                <div class="collapse {{ request()->routeIs(['divisi.*', 'pic.*']) ? 'show' : '' }} sub-menu"
                    id="menuKaryawan">
                    <a href="{{ route('divisi.index') }}"
                        class="{{ request()->routeIs('divisi.*') ? 'active-sub' : '' }}">FUNGSI <i
                            class="fa-solid fa-building"></i></a>
                    <a href="{{ route('pic.index') }}"
                        class="{{ request()->routeIs('pic.*') ? 'active-sub' : '' }}">KARYAWAN <i
                            class="fa-solid fa-user-tie ms-2"></i></a>
                </div>
                ...
                <div class="collapse {{ request()->routeIs(['gedung.*', 'lantai.*', 'jenis-ruangan.*', 'ruangs.*']) ? 'show' : '' }} sub-menu"
                    id="menuLokasi">
                    <a href="{{ route('gedung.index') }}"
                        class="{{ request()->routeIs('gedung.*') ? 'active-sub' : '' }}">GEDUNG <i
                            class="fa-solid fa-city"></i></a>
                    <a href="{{ route('lantai.index') }}"
                        class="{{ request()->routeIs('lantai.*') ? 'active-sub' : '' }}">LANTAI <i
                            class="fa-solid fa-layer-group"></i></a>
                    <a href="{{ route('jenis-ruangan.index') }}"
                        class="{{ request()->routeIs('jenis-ruangan.*') ? 'active-sub' : '' }}">JENIS RUANGAN <i
                            class="fa-solid fa-map-pin"></i></a>
                    <a href="{{ route('ruangs.index') }}"
                        class="{{ request()->routeIs('ruangs.*') ? 'active-sub' : '' }}">RUANG <i
                ...
                <div class="collapse {{ request()->routeIs(['kelompok.*', 'jenis.*', 'subjenis.*']) ? 'show' : '' }} sub-menu"
                    id="menuBarang">
                    <a href="{{ route('kelompok.index') }}"
                        class="{{ request()->routeIs('kelompok.*') ? 'active-sub' : '' }}">KELOMPOK ITEM <i
                            class="fa-solid fa-box-archive"></i></a>
                    <a href="{{ route('jenis.index') }}"
                        class="{{ request()->routeIs('jenis.*') ? 'active-sub' : '' }}">JENIS ITEM <i
                            class="fa-solid fa-tags"></i></a>
                    <a href="{{ route('subjenis.index') }}"
                        class="{{ request()->routeIs('subjenis.*') ? 'active-sub' : '' }}">SUB JENIS <i
            ...
            <div class="collapse {{ request()->routeIs(['barang.*', 'barang-sewa.*']) ? 'show' : '' }} sub-menu"
                id="menuInventaris">
                <a href="{{ route('barang.index') }}" class="{{ request()->routeIs('barang.*') ? 'active-sub' : '' }}">
                    ITEM INVENTARISASI <i class="fa-solid fa-database"></i>
                </a>
                <a href="{{ route('barang-sewa.index') }}"
                    class="{{ request()->routeIs('barang-sewa.*') ? 'active-sub' : '' }}">ITEM SEWA<i
            ...
            @if(Auth::user()->hasRole('superadmin'))
                ...
                <div class="collapse {{ request()->routeIs(['users.*']) ? 'show' : '' }} sub-menu" id="menuManagementAkun">
                    <a href="{{ route('users.index') }}"
                        class="{{ request()->routeIs('users.*') ? 'active-sub' : '' }}">AKUN <i
    ...
    <div class="main-wrapper">
        ...
        <div class="top-navbar">
            ...
            <div class="d-flex align-items-center gap-4 text-muted icon-top">
                ...
                <!-- NOTIFIKASI -->
                <i class="fa-regular fa-bell" data-bs-toggle="modal" data-bs-target="#notifModal"></i>

                <!-- USER -->
                <i class="fa-regular fa-user" data-bs-toggle="offcanvas" data-bs-target="#userPanel"></i>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p style="text-align: justify;">
                        SMART-UMRO (Sistem Manajemen Aset Terintegrasi) adalah aplikasi digital yang digunakan untuk
                        mengelola data inventaris secara terpusat, mulai dari pencatatan barang, lokasi, PIC (penanggung
                        jawab), hingga kondisi aset. Sistem ini dilengkapi fitur QR Code untuk mempermudah identifikasi
                        dan pengecekan barang secara cepat dan akurat, sehingga meningkatkan efisiensi, transparansi,
                        dan kontrol dalam pengelolaan aset.
                    </p>
        ...
        function highlight(text, keyword) {
            ...
            let html = '';
                ...
                <div class="search-text">
                    ...
                    ${subtitle ? `<small class="text-muted">${highlight(subtitle, keyword)}</small>` : ''}
                </div>

                <i class="fa-solid fa-arrow-up-right-from-square search-icon-right"></i>
            </a>
        `;
            }
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="userPanel">
        ...
        <div class="offcanvas-header"
            style="background: linear-gradient(135deg, #309FB0 0%, #1b6b7a 100%); color:white; padding: 20px;">
            <div>
        ...
        <div class="offcanvas-body p-4">
            ...
            <div id="profileView">
                ...
                <!-- Avatar Card -->
                <div
                    style="background: linear-gradient(135deg, #309FB0 0%, #42b5d8 100%); border-radius: 20px; padding: 30px 20px; margin-bottom: 25px; box-shadow: 0 8px 25px rgba(48, 159, 176, 0.2);">
                    <div
                        style="width: 100px; height: 100px; background: rgba(255,255,255,0.2); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px; backdrop-filter: blur(10px); border: 3px solid rgba(255,255,255,0.3);">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-6">
                        <div
                            style="background: linear-gradient(135deg, #E3F2FD 0%, #F3E5F5 100%); border-radius: 12px; padding: 15px; border: 1px solid #e0e0e0;">
                    ...
                    <div class="col-6">
                        <div
                            style="background: linear-gradient(135deg, #E8F5E9 0%, #FFF3E0 100%); border-radius: 12px; padding: 15px; border: 1px solid #e0e0e0;">
                ...
                <!-- Join Date Card -->
                <div
                    style="background: #f8f9fa; border-radius: 12px; padding: 15px; margin-bottom: 25px; border-left: 4px solid #309FB0;">
                ...
                <div class="d-grid gap-2">
                    ...
                    <button class="btn"
                        style="background: linear-gradient(135deg, #309FB0 0%, #42b5d8 100%); color: white; border: none; padding: 12px; font-weight: 600; border-radius: 10px; transition: all 0.3s ease;"
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <button class="btn w-100"
                            style="background: linear-gradient(135deg, #f44336 0%, #e91e63 100%); color: white; border: none; padding: 12px; font-weight: 600; border-radius: 10px; transition: all 0.3s ease;"
            ...
            <div id="profileEdit" style="display:none;">
                ...
                <div
                    style="background: linear-gradient(135deg, #E3F2FD 0%, #F3E5F5 100%); border-radius: 15px; padding: 20px; margin-bottom: 25px; border-left: 4px solid #309FB0;">
                ...
                <form method="POST" action="{{ route('profile.update') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <small style="color: #6c757d; display: block; margin-top: 5px;">
                            <i class="fa-solid fa-circle-info me-1"></i> Biarkan kosong jika tidak ingin mengubah
                            password
                        </small>
                    </div>
