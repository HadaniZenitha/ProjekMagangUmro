                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control bg-light border-0" value="{{ $barang->kode_barang }}"
                                    readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-semibold">Sub Jenis</label>
                                <input type="text" class="form-control bg-light border-0"
                                    value="{{ $barang->subjenis->nama_subjenis }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="mb-4" id="catatanWrapper" style="{{ $barang->is_active ? 'display:none;' : '' }}">
                            ...
                            <textarea name="catatan_nonaktif" class="form-control border-danger"
                            ...
                            <div class="card-body text-center">
                                ...
                                <div class="mb-3">
                                    @if ($barang->foto && file_exists(public_path('storage/' . $barang->foto)))
                                        <img src="{{ asset('storage/' . $barang->foto) }}" id="preview"
