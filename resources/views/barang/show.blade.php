        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-7">
                @if(!$barang->is_active)
                    <div class="alert alert-danger border-0 shadow-sm mb-4">
                        ...
                        <p class="mb-0 small italic">
                            "{{ $barang->catatan_nonaktif ?? 'Tidak ada catatan alasan penonaktifan.' }}"</p>
                    </div>
                @endif
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3 align-items-center">
                            ...
                            <div class="col-sm-8">
                                <span
                                    class="badge rounded-pill bg-{{ $barang->kondisi == 'baik' ? 'success' : ($barang->kondisi == 'perlu perbaikan' ? 'warning' : 'danger') }} px-3">
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white py-3">
                        <h6 class="fw-bold mb-0"><i class="fa-solid fa-clock-rotate-left me-2 text-primary"></i>Riwayat
                            Perubahan</h6>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @forelse($barang->barangHistories->sortByDesc('tanggal_perubahan') as $history)
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-{{ $history->kondisi == 'baik' ? 'success' : ($history->kondisi == 'perlu perbaikan' ? 'warning' : 'danger') }} py-1 px-2"
