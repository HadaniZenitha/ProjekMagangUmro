                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <span class="badge rounded-pill bg-{{ $color }}"
                                                    style="width: 8px; height: 8px; padding: 0; margin-right: 8px;"></span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <span class="text-muted small">{{ $history->picLama->nama_pic ?? 'Awal'
                                                    }}</span>
                                                <i class="fa-solid fa-arrow-right text-primary"
