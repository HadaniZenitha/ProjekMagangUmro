...
@section('content')
    ...
    <div class="mb-3 d-flex flex-md-row flex-column align-items-md-center">
        ...
        <a href="{{ route('ruangs.create') }}" class="btn btn-warning btn-clean btn-mobile-full ms-md-auto mt-2 mt-md-0">
                    ...
                    @forelse($ruangs as $r)
                        <tr>
                            ...
                            <td class="text-nowrap fw-semibold">
                                <span class="badge bg-dark">{{ $r->kode_ruang }}</span>
                            </td>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-2 flex-nowrap">
                                    ...
                                    <a href="{{ route('ruangs.show', $r->id) }}" class="btn btn-info btn-sm">
                                        <i class="fa-solid fa-eye"></i>
                                    </a>

                                    <a href="{{ route('ruangs.edit', $r->id) }}" class="btn btn-warning btn-sm">
                                        <i class="fa-solid fa-pen"></i>
                                    </a>

                                    <form action="{{ route('ruangs.destroy', $r->id) }}" method="POST"
